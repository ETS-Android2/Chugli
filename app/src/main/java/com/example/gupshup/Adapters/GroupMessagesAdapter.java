...
import com.example.gupshup.databinding.ItemReceiveGroupBinding;
import com.example.gupshup.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            FirebaseDatabase.getInstance()  //getting the name of the sender in group so that we can show his name in the group chats
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {  //for deleting messages
                @Override
